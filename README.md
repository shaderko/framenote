...
Playback support follows the operating system webview. MP4/H.264 is the safest cross-platform choice; a selected container or codec can still be rejected by the platform even when FFmpeg can analyze it. FrameNote reports this without touching the file.
